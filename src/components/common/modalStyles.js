...
export const dashboardInputClass =
  "min-h-[2.5rem] w-full px-4 py-2 rounded-xl border border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500 focus:outline-none focus:ring-2 focus:ring-eco-500/80 focus:border-eco-500";
...
export const modalPrimaryButtonClass =
  "inline-flex flex-1 items-center justify-center gap-2 min-h-[2.5rem] px-4 py-2 rounded-xl font-medium text-white bg-eco-600 hover:bg-eco-700 focus:outline-none focus:ring-2 focus:ring-eco-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800 transition-colors";

export const modalSecondaryButtonClass =
  "inline-flex flex-1 items-center justify-center gap-2 min-h-[2.5rem] px-4 py-2 rounded-xl font-medium border border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors";
